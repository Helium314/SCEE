    ...
    suspend fun loadStyle(): Style {
        ...
        val styleJsonString = when {
            prefs.prefs.getString(Prefs.THEME_BACKGROUND, "MAP") != "MAP" ->
                createMapStyle("StreetComplete-Raster", token, emptyList(), rasterBackground(prefs.prefs.getBoolean(Prefs.NO_SATELLITE_LABEL, false)), prefs.prefs.getString(Prefs.RASTER_TILE_URL, "https://server.arcgisonline.com/arcgis/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}"), prefs.prefs.getString(Prefs.RASTER_TILE_MAXZOOM, 21))
