...
fun QuickSettingsDropdown(
    ...
    DropdownMenu(
        ...
        {
            Text(text = stringResource(Res.string.quick_switch_preset))
        }
        DropdownMenuItem(onClick = { levelFilterDialog = true })
        {
            Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.SpaceBetween, modifier = Modifier.fillMaxWidth()) {
                Text(text = stringResource(Res.string.level_filter))
        ...
        DropdownMenuItem(onClick = {
            ...
            Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.SpaceBetween, modifier = Modifier.fillMaxWidth()) {
                Text(text = stringResource(Res.string.quest_order_reverse))
