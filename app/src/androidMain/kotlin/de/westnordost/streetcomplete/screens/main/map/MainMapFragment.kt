    ...
    fun onLocationEvent(locationEvent: LocationEvent) {
        when (locationEvent) {
            is LocationEvent.Update -> {
                ...
                if (locationEvent.measurementMark.elapsedNow() > 10.minutes) return // on startup we get the last known position, which is usually useless and can be incredibly annoying
