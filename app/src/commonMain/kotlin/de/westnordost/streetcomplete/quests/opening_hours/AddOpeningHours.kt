    ...
    @Composable override fun QuestSettings(onDismissRequest: () -> Unit) {
            ...
            text = {
                Column {
                    Button({ showResurveySelection = true }, Modifier.fillMaxWidth()) {
                        Text(stringResource(Res.string.quest_settings_resurvey_all_opening_hours_title))
                    }
        ...
        if (showResurveySelection)
            BooleanQuestSettingsDialog(
                ...
                false,
                Res.string.quest_settings_resurvey_all_opening_hours_message,
                Res.string.quest_settings_resurvey_all_opening_hours_yes,
                Res.string.quest_settings_resurvey_all_opening_hours_no
